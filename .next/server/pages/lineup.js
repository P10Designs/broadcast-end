    ...
    const deletePlayer = async ()=>{
        ...
        if (player1 !== undefined) {
            toEdit = toEdit.filter((e)=>{
                console.log(e.name, player1.name, e.name !== player1.name);
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("button", {
                                    ...
                                    className: "mx-1.5 bg-red-500 px-2 py-1 rounded-md inline-flex uppercase text-xs font-bold items-center justify-center hover:bg-red-700 transition-all",
                                    children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [675,339,343], () => (__webpack_exec__(877)));
